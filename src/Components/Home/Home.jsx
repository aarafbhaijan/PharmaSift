...
const Home = () => {
  return (
    <>
      <div className="flex">
        <div className=" scroll-smooth flex md:justify-self-end justify-center  items-center md:flex-row flex-col min-h-[80vh] w-screen 2xl:justify-center space-x-40 xl:gap-40 ">
          <div className="justiy-self-center border-black md:w-[45%] w-fit h-fit py-10">
          ...
          <div className=" xl:normal  md:flex hidden justify-self-center">
