...
const MobileCarousel = () => {
  return (
    ...
    <div class="relative rounded-lg block md:flex items-center bg-gray-100 shadow-xl min-h-[19rem]">
      <div class="relative w-full md:w-2/5 h-full overflow-hidden rounded-t-lg md:rounded-t-none md:rounded-l-lg min-h-[19rem] " >
    ...
    <div class="flex items-center pt-5 justify-between">
      <button class="px-2 opacity-50 hover:opacity-100 focus:opacity-100"><img class="w-full max-h-[60px]" src="https://stripe.com/img/v3/payments/overview/logos/kickstarter.svg" alt=""/></button>
      <button class="px-2 opacity-50 hover:opacity-100 focus:opacity-100"><img class="w-full max-h-[60px]" src="https://stripe.com/img/v3/payments/overview/logos/slack.svg" alt="" /></button>
      <button class="px-2 opacity-50 hover:opacity-100 focus:opacity-100"><img class="w-full max-h-[60px]" src="https://stripe.com/img/v3/payments/overview/logos/glossier.svg" alt=""/></button>
      <button class="px-2 opacity-50 hover:opacity-100 focus:opacity-100"><img class="w-full max-h-[60px]" src="https://stripe.com/img/v3/payments/overview/logos/charity_water.svg" alt="" /></button>
      <button class="px-2 opacity-100 hover:opacity-100 focus:opacity-100"><img class="w-full max-h-[60px]" src="https://stripe.com/img/v3/payments/overview/logos/missguided.svg" alt="" /></button>
    </div>
